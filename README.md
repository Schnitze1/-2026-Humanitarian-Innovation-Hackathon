...
- **Tailored NGO Profiles & Guidelines**: Persistent PostgreSQL database stores client guidelines injected directly into the LLM system prompt.
- **Contextual South Pacific Imagery**: Dynamic integration with LoremFlickr specifically programmed to pull localized photography from South Pacific nations (Fiji, Samoa, Vanuatu, Tonga) aligned to 14 specific NGO issues.
